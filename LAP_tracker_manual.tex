...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\#\# Add current user to dialout group (needs reboot)}
\FunctionTok{sudo}\NormalTok{ usermod }\AttributeTok{{-}a} \AttributeTok{{-}G}\NormalTok{ dialout }\VariableTok{$USER}
\CommentTok{\#\# Allow anyone to use the device (less secure, not permanent)}
\FunctionTok{sudo}\NormalTok{ chmod 666 /dev/ttyUSB0 }
\end{Highlighting}
\end{Shaded}
...
{\centering \includegraphics[width=0.8\linewidth]{../../Aerosols/Photos/EL/20160307_Tracker_CHP1_CCD/20160307_124618} 
